...
try{
	 ...
	 String sql_cat="";
	 String sql="";
	 sql_cat="select * from order_cny  where order_status='กำลังจัดส่ง'";
		if (sName!=null){
			sql="Select * from order_cny where order_id like '"+'%'+sName+'%'+"' or pro_id like '"+'%'+sName+'%'+"' and order_status='กำลังจัดส่ง'";
		}
		else{
		sql="select * from order_cny where order_status='กำลังจัดส่ง'";
		}
