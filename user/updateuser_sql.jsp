...
try{
		if(!connection.isClosed()){
		 ...
		 String sql_replate="";
	 	 sql_replate="update user set username='"+username+"',password='"+password+"',status='"+status+"' where user_id='"+id+"'";
	int res_replate1=stmt_replate.executeUpdate(sql_replate);
	 ...
	 if (res_replate1>0){
		...
		%>
		<meta http-equiv="refresh" content="0;url=../admin/select_user.jsp" />			<%
		}
		else{
