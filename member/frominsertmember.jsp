...
<%@page pageEncoding="UTF-8"%>
      ...
      <div class="modal fade" id="brand" tabindex="-1" role="dialog" aria-labelledby="brand">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <br>
                <form class="form-horizontal"action="../member/insertmember.jsp" >		
  ...
  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="line" name="line"maxlength="250">
                        </div>
						<label for="facebook" class="col-sm-2 control-label">เฟสบุ๊ค</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="pass" name="facebook"maxlength="250">
                        </div>
                    </div>
