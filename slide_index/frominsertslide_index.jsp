        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="brand">เพิ่มข้อมูล</h4>
                </div>
                <br>
                <form class="form-horizontal"action="../slide_index/insertslide_sql.jsp" >		
                    <div class="form-group">
                        <label for="fname" class="col-sm-2 col-md-2 control-label">รหัส:<font color="#ff0000">*</font></label>
