 ...
 <div class="modal fade" id="brand" tabindex="-1" role="dialog" aria-labelledby="brand">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <br>
                <form class="form-horizontal" method="get" action="../img_index/insertimg_index_sql.jsp" >		
                    <div class="form-group">

                        <label for="image" class="col-sm-2 control-label">ชื่อรูป:<font color="#ff0000">*</font></label>
                        <div class="col-sm-3 col-md-8">
                            <input type="text" class="form-control" id="surname" name="image" maxlength="250"id="surname">
                            <p id="spsurname">
                        </div>
